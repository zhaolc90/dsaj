...
bst = new BST()
var array = [5,6,9,7,1,2]
array.map(function(node){
    bst.insert(node)
})

console.log("getInorder :",bst.getInorder(bst.getRoot()))
console.log("getPreorder :",bst.getPreorder(bst.getRoot()))
console.log("getPostorder :",bst.getPostorder(bst.getRoot()))
console.log("path :",bst.path(7))
